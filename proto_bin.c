...
void complete_nread_binary(conn *c) {
    fprintf(stderr, "complete_nread_binary\n");
    assert(c != NULL);
    assert(c->cmd >= 0);
...
int try_read_command_binary(conn *c) {
    fprintf(stderr, "try_read_command_binary\n");
...
void write_bin_error(conn *c, protocol_binary_response_status err,
    ...
    fprintf(stderr, "write_bin_error\n");
    size_t len;
...
static void handle_binary_protocol_error(conn *c) {
    fprintf(stderr, "handle_binary_protocol_error\n");
...
static void write_bin_response(conn *c, void *d, int hlen, int keylen, int dlen) {
    fprintf(stderr, "write_bin_response\n");
...
static void complete_incr_bin(conn *c, char *extbuf) {
    fprintf(stderr, "complete_incr_bin\n");
    item *it;
    char *key;
    size_t nkey;
...
static void complete_update_bin(conn *c) {
    fprintf(stderr, "complete_update_bin\n");
...
static void write_bin_miss_response(conn *c, char *key, size_t nkey) {
    fprintf(stderr, "write_bin_miss_response\n");
    if (nkey) {
...
static void process_bin_get_or_touch(conn *c, char *extbuf) {
    fprintf(stderr, "process_bin_get_or_touch\n");
    item *it;
...
static void process_bin_stat(conn *c) {
    fprintf(stderr, "process_bin_stat\n");
...
static void bin_list_sasl_mechs(conn *c) {
    fprintf(stderr, "bin_list_sasl_mechs\n");
...
static void process_bin_sasl_auth(conn *c) {
    fprintf(stderr, "process_bin_sasl_auth\n");
...
static void process_bin_complete_sasl_auth(conn *c) {
    fprintf(stderr, "process_bin_complete_sasl_auth\n");
...
static void dispatch_bin_command(conn *c, char *extbuf) {
    fprintf(stderr, "dispatch_bin_command\n");
...
static void process_bin_update(conn *c, char *extbuf) {
    fprintf(stderr, "process_bin_update\n");
    char *key;
    int nkey;
    int vlen;
    item *it;
...
static void process_bin_append_prepend(conn *c) {
    fprintf(stderr, "process_bin_append_prepend\n");
    char *key;
    int nkey;
    int vlen;
    item *it;
...
static void process_bin_flush(conn *c, char *extbuf) {
    fprintf(stderr, "process_bin_flush\n");
    time_t exptime = 0;
...
static void process_bin_delete(conn *c) {
    fprintf(stderr, "process_bin_delete\n");
    item *it;
    uint32_t hv;
